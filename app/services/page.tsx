...
interface ServiceCardProps {
  ...
  Icon: IconType;
  id: string;
  className?: string; // Allow custom styling with className
}

const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, Icon, id, className }) => (
  <div id={id} className={`border border-gray-300 p-6 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:border-yellow-500 group ${className}`}>
